...
const projects = [
  {
    titleKey: "ecommerceTitle" as const,
    descKey: "ecommerceDesc" as const,
  ...
  {
    titleKey: "taskTitle" as const,
    descKey: "taskDesc" as const,
  ...
  {
    titleKey: "fitnessTitle" as const,
    descKey: "fitnessDesc" as const,
